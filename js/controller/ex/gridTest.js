	...
	app.controller('BodyController',['$scope','$window','$timeout','$interval','$filter','kaisaGrid','kaisaApi',function($scope,$window,$timeout,$interval,$filter,kaisaGrid,kaisaApi){
		...
		$scope.dicGrid = kaisaGrid.init($scope,{
			...
			header : [
				...
				,{key:'TEST',				name:'TEST',		type:'Number',    width:100,  length:90, visible:false,	disabled:true,	align:'right'}
				...
				,{key:'CREATE_DATE',		name:'등록일시',  	type:'Date',	  width:170,  length:30, visible:true,	disabled:true,	align:'left', dateFormat: 'yyyy-MM-dd HH:mm'}
